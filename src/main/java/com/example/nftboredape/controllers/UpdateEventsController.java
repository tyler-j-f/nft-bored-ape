...
public class UpdateEventsController {
   ...
   *
   * @param eventId Event SQL id to get transfer events for
   *                This SQL id value will be printed when this API is hit to display events by address or tokenId
   * @return A JSON list of all events
   */
  @GetMapping(value = "markEventAsRead/{eventId}")
  public String markEventAsRead(
    ...
    transferEventsRepository.update(
        event
    );
