...
public class GetEthEventsTask {
   ...
   * View the Bored Ape NFT smart contract code here:
   * https://etherscan.io/address/0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d#code
   *
   * In the Solidity code we will see:
   * event Transfer(address indexed from, address indexed to, uint256 indexed tokenId);
   *
   * This is the Solidity event we will be looking for.
   *
  ...
  public List<EventDTO> getEvents() throws EthEventException {
    try {
      ...
      DefaultBlockParameter fromBlock = DefaultBlockParameter.valueOf(currentBlockNumber.subtract(
          BigInteger.valueOf(ethConfig.getNumberOfBlocksAgo())
      ));
      EthFilter filter =
          new EthFilter(
              fromBlock,
